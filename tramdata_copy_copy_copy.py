...
os.chdir("/Users/jvbahr/Library/CloudStorage/OneDrive-Personal/PythonKurs/Fortsättning/Lab1") #denna är inge bra. 

def build_tram_stops(jsonobject): 

    with open(jsonobject) as file: 
        data = json.load(file) #funjar inte. 
        stopdict = {}
...
#time with 1 from Opaltorget to Östra Sjukhuset
...
def dialouge(tramfile):  # laddar in den skapta tramnetworkfilen. Samt loopar efter prompt. Skickar sedan filens samtliga dictionaries och query till anser_query. 
    ...
    linedict = data["lines"]
    timedict = data["times"]
    tramdict = {"stopdict": stopdict, "linedict": linedict, "timedict": timedict}
